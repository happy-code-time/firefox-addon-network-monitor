...
import setItemRemote from '../Functions/storage/setItemRemote';
...
class ListGlobalModule extends React.Component<ListGlobalModuleProps> {
    ...
    deleteAll() {
        ...
        this.setState({
            ...
            if (null == getCurrentLoggedInUser()) {
                errorMessage = this.translations.listNotSynchronizedUserNotLoggedIn;
            }
            ...
            if (data && data.length) {
                ...
                await setItemRemote(this.storageName, [], 'empty');

                this.setState({
                    errorMessage,
                    successMessage: this.translations.emptyListDone,
                    data: [],
                    animationLoading: false
                });
            }
        ...
        this.setState({
            ...
            if (!value.length) {
                return this.setState({
                    errorMessage: `Error while adding value to the current list ${this.listReadable}. Value cannot be an empty string`,
                    successMessage: '',
                    animationLoading: false
                });
            }
        ...
        setTimeout(() => {
            ...
            if (this.state.jsonData) {
                try {
                    ...
                    FileSaver.saveAs(blob, `Protector_SETTINGS_${customKey()}.json`);
                } catch (error) {
    ...
    render() {
        const { animationLoading, data, errorMessage, successMessage } = this.state;
        ...
        return (
            <div className="Blacklist">
                ...
                {
                    '' !== errorMessage &&
                    <div className="error-message" onClick={(e) => this.setState({ errorMessage: '' })}>
                        {
                            '' !== errorMessage &&
                ...
                {
                    '' !== successMessage &&
                    <div className="successMessages-message" onClick={(e) => this.setState({ successMessage: '' })}>
                        {
                            '' !== successMessage &&
