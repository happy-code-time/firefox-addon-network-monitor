...
class External extends React.Component 
{
    ...
    getExternalSourceCode() {
        const { inputValue, methodValue } = this.state;
    ...
    setResponse(externalCode, requestEnd) {
        ...
        if(!data){
            return addToStore(this.translations.responseEmpty, -1);
        }
        ...
        return this.setState({
            ...
            codeJsx: (
                <div key={customKey()} className="code-box-holder">
                    <h1>
                        {`${methodValue.toUpperCase()} | ${inputValue}`}
                    </h1>
